 ...
 * and open the template in the editor.
    ...
    private static Step1SecurityPlanJpaController step1SecurityPlanJpaController = null;
    ...
    //======================== 19 ========================
    public static Step1SecurityPlanJpaController getStep1SecurityPlanJpaController() {
        if (step1SecurityPlanJpaController == null) {
            step1SecurityPlanJpaController = new Step1SecurityPlanJpaController(getEntityManager());
        }
        return step1SecurityPlanJpaController;
    }
