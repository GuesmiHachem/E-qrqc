...
public class Step1JpaController implements Serializable {
    ...
    public Step1 create(Step1 step1) {
        ...
        if (step1.getStep1SecurityPlanList() == null) {
            step1.setStep1SecurityPlanList(new ArrayList<Step1SecurityPlan>());
        }
        ...
        try {
            ...
            List<Step1SecurityPlan> attachedStep1SecurityPlanList = new ArrayList<Step1SecurityPlan>();
            for (Step1SecurityPlan step1SecurityPlanListStep1SecurityPlanToAttach : step1.getStep1SecurityPlanList()) {
                step1SecurityPlanListStep1SecurityPlanToAttach = em.getReference(step1SecurityPlanListStep1SecurityPlanToAttach.getClass(), step1SecurityPlanListStep1SecurityPlanToAttach.getId());
                attachedStep1SecurityPlanList.add(step1SecurityPlanListStep1SecurityPlanToAttach);
            }
            step1.setStep1SecurityPlanList(attachedStep1SecurityPlanList);
            ...
            for (Step1SecurityPlan step1SecurityPlanListStep1SecurityPlan : step1.getStep1SecurityPlanList()) {
                Step1 oldIdStep1OfStep1SecurityPlanListStep1SecurityPlan = step1SecurityPlanListStep1SecurityPlan.getIdStep1();
                step1SecurityPlanListStep1SecurityPlan.setIdStep1(step1);
                step1SecurityPlanListStep1SecurityPlan = em.merge(step1SecurityPlanListStep1SecurityPlan);
                if (oldIdStep1OfStep1SecurityPlanListStep1SecurityPlan != null) {
                    oldIdStep1OfStep1SecurityPlanListStep1SecurityPlan.getStep1SecurityPlanList().remove(step1SecurityPlanListStep1SecurityPlan);
                    oldIdStep1OfStep1SecurityPlanListStep1SecurityPlan = em.merge(oldIdStep1OfStep1SecurityPlanListStep1SecurityPlan);
                }
            }
    ...
    public void edit(Step1 step1) throws IllegalOrphanException, NonexistentEntityException, Exception {
        ...
        try {
            ...
            List<Step1SecurityPlan> step1SecurityPlanListOld = persistentStep1.getStep1SecurityPlanList();
            List<Step1SecurityPlan> step1SecurityPlanListNew = step1.getStep1SecurityPlanList();
            ...
            for (Step1SecurityPlan step1SecurityPlanListOldStep1SecurityPlan : step1SecurityPlanListOld) {
                if (!step1SecurityPlanListNew.contains(step1SecurityPlanListOldStep1SecurityPlan)) {
                    if (illegalOrphanMessages == null) {
                        illegalOrphanMessages = new ArrayList<String>();
                    }
                    illegalOrphanMessages.add("You must retain Step1SecurityPlan " + step1SecurityPlanListOldStep1SecurityPlan + " since its idStep1 field is not nullable.");
                }
            }
            ...
            List<Step1SecurityPlan> attachedStep1SecurityPlanListNew = new ArrayList<Step1SecurityPlan>();
            for (Step1SecurityPlan step1SecurityPlanListNewStep1SecurityPlanToAttach : step1SecurityPlanListNew) {
                step1SecurityPlanListNewStep1SecurityPlanToAttach = em.getReference(step1SecurityPlanListNewStep1SecurityPlanToAttach.getClass(), step1SecurityPlanListNewStep1SecurityPlanToAttach.getId());
                attachedStep1SecurityPlanListNew.add(step1SecurityPlanListNewStep1SecurityPlanToAttach);
            }
            step1SecurityPlanListNew = attachedStep1SecurityPlanListNew;
            step1.setStep1SecurityPlanList(step1SecurityPlanListNew);
            ...
            for (Step1SecurityPlan step1SecurityPlanListNewStep1SecurityPlan : step1SecurityPlanListNew) {
                if (!step1SecurityPlanListOld.contains(step1SecurityPlanListNewStep1SecurityPlan)) {
                    Step1 oldIdStep1OfStep1SecurityPlanListNewStep1SecurityPlan = step1SecurityPlanListNewStep1SecurityPlan.getIdStep1();
                    step1SecurityPlanListNewStep1SecurityPlan.setIdStep1(step1);
                    step1SecurityPlanListNewStep1SecurityPlan = em.merge(step1SecurityPlanListNewStep1SecurityPlan);
                    if (oldIdStep1OfStep1SecurityPlanListNewStep1SecurityPlan != null && !oldIdStep1OfStep1SecurityPlanListNewStep1SecurityPlan.equals(step1)) {
                        oldIdStep1OfStep1SecurityPlanListNewStep1SecurityPlan.getStep1SecurityPlanList().remove(step1SecurityPlanListNewStep1SecurityPlan);
                        oldIdStep1OfStep1SecurityPlanListNewStep1SecurityPlan = em.merge(oldIdStep1OfStep1SecurityPlanListNewStep1SecurityPlan);
                    }
                }
            }
    ...
    public void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException {
        ...
        try {
            ...
            List<Step1SecurityPlan> step1SecurityPlanListOrphanCheck = step1.getStep1SecurityPlanList();
            for (Step1SecurityPlan step1SecurityPlanListOrphanCheckStep1SecurityPlan : step1SecurityPlanListOrphanCheck) {
                if (illegalOrphanMessages == null) {
                    illegalOrphanMessages = new ArrayList<String>();
                }
                illegalOrphanMessages.add("This Step1 (" + step1 + ") cannot be destroyed since the Step1SecurityPlan " + step1SecurityPlanListOrphanCheckStep1SecurityPlan + " in its step1SecurityPlanList field has a non-nullable idStep1 field.");
            }
