                ...
                <div class="card w3-white w3-border-grey w3-border ">
                    <div class="card-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <form id="registerFormValidation" action="<%=application.getContextPath()%>/MyProfile?id=<%=user.getId()%>" method="post">
                                ...
                                <form id="registerFormValidation" action="<%=application.getContextPath()%>/MyProfile?id=<%=user.getId()%>" method="post" enctype="multipart/form-data" class="">
                                    ...
                                    <div class="<%=Design.containerTitle%>">
                                        <div class="w3-right">
                                            <button  style="border-radius: 5px;margin:3px;" name="" type="submit" class="<%=Design.btn%> w3-hover-white ti-pencil"> 
                                            </button>
                                        </div>
                                    </div>
                                </form>
