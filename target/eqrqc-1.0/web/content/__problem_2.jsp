    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card w3-border w3-border-dark-gray">
                    <div  class="w3-row ">
                        <div class="w3-col l12 w3-dark-gray w3-padding">
                            <div class="w3-left">
                                <h1 class="<%=Design.textTitle%>">Caractérisation</h1>
                            </div>
                            <div class="w3-right">
                                <button  onclick="document.location.href = 'S1P1?id=<%=problem.getId()%>'" type="button" class="w3-btn w3-round  ti-pencil-alt w3-text-dark-gray w3-white w3-border"> 
                                </button>
                            </div>
                        </div>
                    </div>
                    <div class="w3-row w3-white">
                        ...
                        <div class="w3-col l3 w3-padding-small">
                            <div class="w3-row">
                                <div class="w3-col l12">
                                    <div class="w3-panel1 w3-pink w3-round w3-padding ">
                                        <p class="<%=Design.textTitle%> w3-text-white">PIECE MAUVAISE</p>
                                    </div>
                                    <div class="w3-panel1 w3-white w3-round w3-padding w3-margin-bottom">
                                        <br>
                                ...
                                <div class="w3-col l12">
                                    <div class="w3-panel w3-green w3-round w3-padding ">
                                        <p class="<%=Design.textTitle%> w3-text-white">PIECE BONNE </p>
                                    </div>
                                    <div class="w3-panel1 w3-white w3-round w3-padding">
                                        <br>
                                        <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                            <div class="fileinput-new">
                        ...
                        <div class="w3-col l4 w3-padding-small w3-padding-small">
                            <!--#######################################-->
                            <div class="w3-row">
                                <div class="w3-col l12">
                                    <div class="w3-container w3-gray w3-round w3-padding w3-margin-bottom">
                                        <p class="<%=Design.textTitle%>">Qui doit être Alerté <span class="w3-badge w3-round w3-pink"> <%=listStep1AlertShould.size()%></span></p>
                                    </div>
                                ...
                                <div class="w3-col l12">
                                    <br>
                                    <div class="w3-container w3-gray w3-round w3-padding w3-margin-bottom">
                                        <p class="<%=Design.textTitle%>">Qui peut être Alerté <span class="w3-badge w3-round w3-pink"> <%=listStep1AlertCan.size()%></span></p>
                                    </div>
                ...
                <div class="card w3-border w3-border-gray">
                    <div  class="w3-row w3-padding w3-dark-gray">
                        ...
                        <div class="w3-right">
                            <button  onclick="document.location.href = 'S1P2?id=<%=problem.getId()%>'" type="button" class="w3-btn w3-round  ti-pencil-alt w3-text-dark-gray w3-border w3-white"> 
                            </button>
                        </div>
                    </div>
                    <div class="w3-row w3-white">
                        <div class="w3-col l12">
                            ...
                            <div class="w3-container w3-margin w3-light-gray w3-padding w3-round">
                                ...
                                <div class="ui labeled button" tabindex="0" style="margin: 5px;">
                                    ...
                                    <a class="ui basic grey left pointing label">
                                        Oui par &nbsp;
                                        <span  class="w3-medium w3-text-blue"><%=step1.getUserValidation().getName() + " " + step1.getUserValidation().getFirstName()%></span>
                                    </a>
                                </div>
                                <%
                                } else {
                                %>
                                <div class="ui labeled button" tabindex="0" style="margin: 0px;">
                ...
                <div class="card w3-border w3-border-gray">
                    <div  class="w3-row w3-padding w3-dark-gray">
                        <div class="w3-left">
                            <h1 class="<%=Design.textTitle%>" >Analyse et actions définitives </h1>
                        </div>
                    </div>
                    <div class="w3-row w3-padding">   
                        <div class="w3-col l12"> 
                            ...
                            <div  class="w3-row ">
                                <div class="w3-col l12 w3-light-green w3-padding-small w3-round">
                                    <div class="w3-left">
                                        <h1 class="<%=Design.textTitle%>">5 Pourquoi  : <%=step1.getWhat()%></h1>
                                    </div>
                                    <div class="w3-right">
                            ...
                            <div  class="w3-row ">
                                <div class="w3-col l12 w3-light-green w3-padding-small w3-round">
                                    <div class="w3-left">
                                        <h1 class="<%=Design.textTitle%>">Actions</h1>
                                    </div>
                                    <div class="w3-right">
                                        <button style="border-radius: 5px;margin:3px;"  data-toggle="modal" data-target="#addAction" type="button" class="<%=Design.btn%> w3-hover-white ti-plus"> 
                                        </button>
                                    </div>
                                    <div class=" w3-right">
                                        <button onclick="if (window.confirm('Voulez-vous vraiment supprimer ?')) {
                            ...
                            <div  class="w3-row ">
                                <div class="w3-col l12 w3-light-green w3-padding w3-round">
                                    <div class="w3-left">
                                        <h1 class="<%=Design.textTitle%>">Suivi des equipes</h1>
                                    </div>
                                </div>
                            </div>
